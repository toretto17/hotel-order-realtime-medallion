...
These goals align with the reference video (source → ingestion → Medallion → consumption). For **production approach** (video vs our stack, senior-level bar, Gold structure: multiple SQL + one runner), see **docs/VIDEO_ANALYSIS.md** §6–7 and **ARCHITECTURE.md**.
